...
import { templateConfig, hasTemplatesConfigured } from "./templateConfig.js";
      ...
      <header className="app__header">
        <div className="brand">
          {templateConfig.logoUrl && (
            <img src={templateConfig.logoUrl} alt="Hospital logo" />
          )}
          <div>
            <h1>GI Cancer MDT</h1>
        ...
        {activeTab === "New Case" && (
          <section className="card">
            ...
            {!hasTemplatesConfigured && (
              <p className="note">
                Template paths are not configured yet. Add them to <code>web/.env</code>.
              </p>
            )}
            {hasTemplatesConfigured && (
              <div className="info">
                <p>
                  <strong>Intake template:</strong> {templateConfig.intakeTemplatePath}
                </p>
                {templateConfig.decisionTemplatePath && (
                  <p>
                    <strong>Decision template:</strong> {templateConfig.decisionTemplatePath}
                  </p>
                )}
              </div>
            )}
          ...
          <section className="card">
            ...
            <div className="settings">
              <div>
                ...
                <div className="info">
                  <p>
                    <strong>Intake template:</strong> {templateConfig.intakeTemplatePath || "Not set"}
                  </p>
                  <p>
                    <strong>Decision template:</strong> {templateConfig.decisionTemplatePath || "Not set"}
                  </p>
                </div>
              </div>
              <div>
              ...
              <div>
                <h3>Branding</h3>
                <p>Logo URL: {templateConfig.logoUrl || "Not set"}</p>
              </div>
              <div>
                <h3>Governance</h3>
